...
type ModalReducerAction =
  | {
      type: 'show-modal';
      payload: { component: ModalComponent; title: string | null; modalProps?: any; modalClassName: string };
    }
  | { type: 'hide-modal' }
...
export const Modal: React.FC = function Modal() {
  ...
  return (
    <React.Fragment>
      ...
      <dialog
        className={
          'z-40 absolute top-[20vh] mx-auto left-0 right-0 rounded-lg p-0 border-2 primary border-inherit ' +
          (modalClassName || '') +
